...
You also need [Python RAT API](https://github.com/RascalSoftware/python-RAT) to be build and available in your local RAT `conda` session. Look [there](https://github.com/RascalSoftware/python-RAT/blob/main/README.md) on more information how to build python API.
